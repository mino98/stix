...
public class StartMessageEventComplexTypeHandler extends org.apache.ws.jaxme.impl.JMSAXElementParser {
  ...
  public void addAttribute(java.lang.String pURI, java.lang.String pLocalName, java.lang.String pValue) throws org.xml.sax.SAXException {
    ...
    uk.ac.ed.inf.wimo.stix.agent.model.workflow.StartMessageEventComplexType _1 = (uk.ac.ed.inf.wimo.stix.agent.model.workflow.StartMessageEventComplexType) result;
    if ("".equals(pURI)) {
      if ("id".equals(pLocalName)) {
        ...
        return;
      } else if ("message".equals(pLocalName)) {
        _1.setMessage((java.lang.String) pValue);
        return;
      }
    }
