...
public class wikiDumpVisitor implements wikiVisitor
{
   ...
   public Object visit(ASTTerm node, Object data) {
      ...
      if (node.term != null)
      {
         System.out.println(indentString() + "term->");
         data = node.term.jjtAccept(this, data);
      }
      System.out.println(indentString() + "def->");
      data = node.def.jjtAccept(this, data);
      --indent;
      return data;
   }
