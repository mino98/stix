...
public class DataInComplexTypeHandler extends org.apache.ws.jaxme.impl.JMSAXElementParser {
  ...
  public void endElement(java.lang.String pNamespaceURI, java.lang.String pLocalName, java.lang.String pQName, java.lang.Object pResult) throws org.xml.sax.SAXException {
    uk.ac.ed.inf.wimo.stix.agent.model.workflow.DataInComplexType _1 = (uk.ac.ed.inf.wimo.stix.agent.model.workflow.DataInComplexType) result;
    switch (__state) {
      case 1:
        if ("http://www.wimo.inf.ed.ac.uk/stix".equals(pNamespaceURI)  &&  "parameter".equals(pLocalName)) {
