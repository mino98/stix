...
public class StartConditionEventComplexTypeHandler extends org.apache.ws.jaxme.impl.JMSAXElementParser {
  ...
  public void addAttribute(java.lang.String pURI, java.lang.String pLocalName, java.lang.String pValue) throws org.xml.sax.SAXException {
    ...
    uk.ac.ed.inf.wimo.stix.agent.model.workflow.StartConditionEventComplexType _1 = (uk.ac.ed.inf.wimo.stix.agent.model.workflow.StartConditionEventComplexType) result;
    if ("".equals(pURI)) {
      if ("id".equals(pLocalName)) {
        ...
        return;
      } else if ("condition".equals(pLocalName)) {
