...
public class MessageCatchingEventComplexTypeDriver implements org.apache.ws.jaxme.impl.JMSAXDriver {
  public org.xml.sax.helpers.AttributesImpl getAttributes(org.apache.ws.jaxme.impl.JMSAXDriverController pController, java.lang.Object pObject) throws org.xml.sax.SAXException {
    ...
    uk.ac.ed.inf.wimo.stix.agent.model.workflow.MessageCatchingEventComplexType _2 = (uk.ac.ed.inf.wimo.stix.agent.model.workflow.MessageCatchingEventComplexType) pObject;
    ...
    _1.addAttribute("", "timeout", pController.getAttrQName(this, "", "timeout"), "CDATA", pController.getDatatypeConverter().printLong(_2.getTimeout()));
    return _1;
  }
  ...
  public void marshalChilds(org.apache.ws.jaxme.impl.JMSAXDriverController pController, org.xml.sax.ContentHandler pHandler, java.lang.Object pObject) throws org.xml.sax.SAXException {
    uk.ac.ed.inf.wimo.stix.agent.model.workflow.MessageCatchingEventComplexType _1 = (uk.ac.ed.inf.wimo.stix.agent.model.workflow.MessageCatchingEventComplexType) pObject;
