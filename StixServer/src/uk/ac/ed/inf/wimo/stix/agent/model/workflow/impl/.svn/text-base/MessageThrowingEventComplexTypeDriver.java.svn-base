...
public class MessageThrowingEventComplexTypeDriver implements org.apache.ws.jaxme.impl.JMSAXDriver {
  public org.xml.sax.helpers.AttributesImpl getAttributes(org.apache.ws.jaxme.impl.JMSAXDriverController pController, java.lang.Object pObject) throws org.xml.sax.SAXException {
    ...
    uk.ac.ed.inf.wimo.stix.agent.model.workflow.MessageThrowingEventComplexType _2 = (uk.ac.ed.inf.wimo.stix.agent.model.workflow.MessageThrowingEventComplexType) pObject;
  ...
  public void marshalChilds(org.apache.ws.jaxme.impl.JMSAXDriverController pController, org.xml.sax.ContentHandler pHandler, java.lang.Object pObject) throws org.xml.sax.SAXException {
    uk.ac.ed.inf.wimo.stix.agent.model.workflow.MessageThrowingEventComplexType _1 = (uk.ac.ed.inf.wimo.stix.agent.model.workflow.MessageThrowingEventComplexType) pObject;
