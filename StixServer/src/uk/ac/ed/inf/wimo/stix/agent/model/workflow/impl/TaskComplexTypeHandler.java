...
public class TaskComplexTypeHandler extends org.apache.ws.jaxme.impl.JMSAXElementParser {
   ...
   *  2 = While or after parsing the child element {http://www.wimo.inf.ed.ac.uk/stix}DataMapping
   * 
   */
  private int __state;
  ...
  public void addAttribute(java.lang.String pURI, java.lang.String pLocalName, java.lang.String pValue) throws org.xml.sax.SAXException {
    ...
    uk.ac.ed.inf.wimo.stix.agent.model.workflow.TaskComplexType _1 = (uk.ac.ed.inf.wimo.stix.agent.model.workflow.TaskComplexType) result;
    if ("".equals(pURI)) {
      if ("id".equals(pLocalName)) {
        ...
        return;
      } else if ("Clazz".equals(pLocalName)) {
        _1.setClazz((java.lang.String) pValue);
        return;
      } else if ("URL".equals(pLocalName)) {
        _1.setURL((java.lang.String) pValue);
        return;
      }
    }
    ...
    switch (__state) {
      case 0:
        if ("http://www.wimo.inf.ed.ac.uk/stix".equals(pNamespaceURI)  &&  "FlowMapping".equals(pLocalName)) {
          __state = 1;
          org.apache.ws.jaxme.JMManager _2 = getHandler().getJMUnmarshaller().getJAXBContextImpl().getManagerS(uk.ac.ed.inf.wimo.stix.agent.model.workflow.FlowMappingTaskComplexType.class);
      ...
      case 1:
        if ("http://www.wimo.inf.ed.ac.uk/stix".equals(pNamespaceURI)  &&  "DataMapping".equals(pLocalName)) {
          __state = 2;
          org.apache.ws.jaxme.JMManager _5 = getHandler().getJMUnmarshaller().getJAXBContextImpl().getManagerS(uk.ac.ed.inf.wimo.stix.agent.model.workflow.DataMappingComplexType.class);
          java.lang.Object _6 = _5.getElementS();
          org.apache.ws.jaxme.impl.JMSAXElementParser _7 = _5.getHandler();
          _7.init(_1, _6, "http://www.wimo.inf.ed.ac.uk/stix", "DataMapping", _1.getLevel());
  ...
  public void endElement(java.lang.String pNamespaceURI, java.lang.String pLocalName, java.lang.String pQName, java.lang.Object pResult) throws org.xml.sax.SAXException {
    ...
    switch (__state) {
      case 1:
        if ("http://www.wimo.inf.ed.ac.uk/stix".equals(pNamespaceURI)  &&  "FlowMapping".equals(pLocalName)) {
          _1.setFlowMapping(((uk.ac.ed.inf.wimo.stix.agent.model.workflow.FlowMappingTaskComplexType) pResult));
          return;
        }
        break;
      case 2:
