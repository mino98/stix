...
public class EventComplexTypeDriver implements org.apache.ws.jaxme.impl.JMSAXDriver {
  public org.xml.sax.helpers.AttributesImpl getAttributes(org.apache.ws.jaxme.impl.JMSAXDriverController pController, java.lang.Object pObject) throws org.xml.sax.SAXException {
    ...
    uk.ac.ed.inf.wimo.stix.agent.model.workflow.EventComplexType _2 = (uk.ac.ed.inf.wimo.stix.agent.model.workflow.EventComplexType) pObject;
