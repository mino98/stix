...
public class TerminateEventComplexTypeHandler extends org.apache.ws.jaxme.impl.JMSAXElementParser {
  public void addAttribute(java.lang.String pURI, java.lang.String pLocalName, java.lang.String pValue) throws org.xml.sax.SAXException {
    ...
    uk.ac.ed.inf.wimo.stix.agent.model.workflow.TerminateEventComplexType _1 = (uk.ac.ed.inf.wimo.stix.agent.model.workflow.TerminateEventComplexType) result;
    if ("".equals(pURI)) {
