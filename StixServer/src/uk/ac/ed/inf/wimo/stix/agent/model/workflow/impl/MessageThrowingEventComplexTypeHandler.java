...
public class MessageThrowingEventComplexTypeHandler extends org.apache.ws.jaxme.impl.JMSAXElementParser {
  public class FlowMappingHandler extends org.apache.ws.jaxme.impl.JMSAXGroupParser {
    ...
    public org.apache.ws.jaxme.impl.JMUnmarshallerHandlerImpl getHandler() {
      return uk.ac.ed.inf.wimo.stix.agent.model.workflow.impl.MessageThrowingEventComplexTypeHandler.this.getHandler();
    }
    ...
    public void endElement(java.lang.String pNamespaceURI, java.lang.String pLocalName, java.lang.String pQName, java.lang.Object pResult) throws org.xml.sax.SAXException {
      uk.ac.ed.inf.wimo.stix.agent.model.workflow.MessageThrowingEventComplexType _1 = (uk.ac.ed.inf.wimo.stix.agent.model.workflow.MessageThrowingEventComplexType) result;
      switch (__state) {
        case 1:
          if ("http://www.wimo.inf.ed.ac.uk/stix".equals(pNamespaceURI)  &&  "FlowMapping".equals(pLocalName)) {
  ...
  public boolean startElement(java.lang.String pNamespaceURI, java.lang.String pLocalName, java.lang.String pQName, org.xml.sax.Attributes pAttr) throws org.xml.sax.SAXException {
    ...
    switch (__state) {
      case 0:
        if (_1.testGroupParser(new uk.ac.ed.inf.wimo.stix.agent.model.workflow.impl.MessageThrowingEventComplexTypeHandler.FlowMappingHandler(), pNamespaceURI, pLocalName, pQName, pAttr)) {
          __state = 1;
          return true;
        }
        break;
      case 1:
        if (_1.testGroupParser(new uk.ac.ed.inf.wimo.stix.agent.model.workflow.impl.MessageThrowingEventComplexTypeHandler.DataMappingHandler(), pNamespaceURI, pLocalName, pQName, pAttr)) {
          __state = 2;
          return true;
        }
        break;
